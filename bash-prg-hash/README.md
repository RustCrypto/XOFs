...
[build-image]: https://github.com/RustCrypto/XOFs/actions/workflows/bash-prg-hash.yml/badge.svg?branch=master
[build-link]: https://github.com/RustCrypto/XOFs/actions/workflows/bash-prg-hash.yml?query=branch:master
